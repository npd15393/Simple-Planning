...
(cl:in-package simple_planning-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simple_planning-msg:<position> is deprecated: use simple_planning-msg:position instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_planning-msg:x-val is deprecated.  Use simple_planning-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_planning-msg:y-val is deprecated.  Use simple_planning-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_planning-msg:yaw-val is deprecated.  Use simple_planning-msg:yaw instead.")
  (yaw m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<position>)))
  ...
  (cl:format cl:nil "int16 x~%int16 y~%int16 yaw~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'position)))
  "Returns full string definition for message of type 'position"
  (cl:format cl:nil "int16 x~%int16 y~%int16 yaw~%~%~%"))
